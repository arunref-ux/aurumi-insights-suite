...
import { CurrentEmployeeProvider } from "../domains/identity";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aurumi Business Insights" },
      {
        name: "description",
        content:
          "Aurumi Business Insights — the analytics workspace of the Aurumi Business Operating System.",
      },
